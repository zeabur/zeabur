...
<Head>
  ...
  <meta name="twitter:image" content="https://opengraph-dev.zeabur.app/api/og?title=Custom Root Directory&desc=Executed according to the specified root directory" />
  <meta name="og:image" content="https://opengraph-dev.zeabur.app/api/og?title=Custom Root Directory&desc=Executed according to the specified root directory" />
</Head>
