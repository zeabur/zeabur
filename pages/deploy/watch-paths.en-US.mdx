...
<Head>
  ...
  <meta name="zeabur:image:subtitle" content="some code updates do not require a service to be redeployed" />
</Head>

# Watch Paths

After your service is deployed, you may often update your code, but ome code updates do not require a service to be redeployed.
