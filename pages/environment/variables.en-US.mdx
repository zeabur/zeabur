...
Zeabur provides a way to set environment variables for your application.

You can set environment variables in the **Variables** tab of your application, and you can **Add Variables** to your application.

![environment variables](/environment/add-variables.en-US.png)

Zeabur will automatically inject these environment variables into your application.

- `<YOUR_SERVICES_NAME>_HOST`：The host of the service.
