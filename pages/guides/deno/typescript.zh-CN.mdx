---
title: TypeScript
ogImageTitle: 部署 TypeScript 应用
ogImageSubtitle: 在 Zeabur 部署您的 TypeScript 应用
---

# 部署 TypeScript 应用

本文将会教您如何在 Zeabur 上部署您的 [Deno](https://deno.land/) 应用。
...
记得在 `serve` 函数中将连接端参数 `port` 的值修改为 `Deno.env.get("PORT")`。
...
接下来，您就可以开始修改代码来开发您的 TypeScript 应用了。
