...
```
為了讓其他人可以透過 NGINX 服務存取我們的內部 Vaultwarden，我們在 NGINX 中使用 `proxy_pass http://vaultwarden.zeabur.internal:80;` 指令，表示讓 NGINX 將連線到此處的所有請求都代理到 Vaultwarden。我們利用 [服務內網](/deploy/private-networking) 功能，在我們的私有網路中透過固定主機名稱存取 Vaultwarden。
