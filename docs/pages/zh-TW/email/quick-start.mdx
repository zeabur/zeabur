...
- 查看 [REST API 參考](/zh-TW/email/rest-api) 了解更多功能
- 設定 [Webhook](/zh-TW/email/webhooks) 接收郵件狀態通知
- 學習如何發送[帶附件的郵件](/zh-TW/email/rest-api#發送帶附件的郵件)
- 了解[定時發送](/zh-TW/email/rest-api#定時發送郵件)和[批次發送](/zh-TW/email/rest-api#批次發送郵件)
