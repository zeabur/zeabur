...
<Callout type="info">
  此高可用性架構適用於**專用伺服器**和**專用叢集**。但水平擴縮（服務副本）需要**專用叢集**（多節點 Kubernetes 叢集）。Zeabur 也正在[逐步淘汰共享叢集](https://zeabur.com/changelogs/phasing-out-shared-cluster)，新專案請使用專用伺服器或專用叢集。
</Callout>
