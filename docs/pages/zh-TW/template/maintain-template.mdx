...
1. 修改你的 Template Resource YAML 檔案（格式參考[從 YAML 建立模板](/template/template-in-code)）。
...
<Callout type="info">
獎勵申請方式：前往 [Zeabur Discord 伺服器](https://zeabur.com/dc) 開啟 ticket，提供模板連結與你的帳號資訊。
</Callout>
...
- **回應使用者回饋** — 留意 Discord 社群中關於你模板的問題回報，及時修復或補充說明。
