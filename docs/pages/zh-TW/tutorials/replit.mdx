...
## 步驟 2: 在本機編輯器中開啟並安裝 Zeabur 擴充功能

解壓縮檔案並在 VS Code 或 Cursor 等本機程式碼編輯器中開啟專案資料夾。為了使部署變得非常簡單，您將使用 Zeabur 擴充功能。
...
![Zeabur 代理程式處理其餘部分](https://cdn.zeabur.com/replit%20migration%20/Zeabur%20Agent%20Handle%20the%20rest.png)
