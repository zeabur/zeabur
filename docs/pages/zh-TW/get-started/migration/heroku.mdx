...
| 擴展 | Dyno 類型（Basic、Standard、Performance） | 在主控台設定資源分配 |
...
| 計價模式 | 按 dyno 月費計價 | [訂閱方案](/pricing) + 伺服器費用 |
...
完成了！您的 Heroku 應用程式現在已在 Zeabur 上運行，不再需要 dyno、Procfile 和 slug 大小限制。如果遇到任何問題，請聯繫 [Zeabur 支援](https://zeabur.com/support)。
