...
ogImageSubtitle: 將 Docker image 部署到 Zeabur 上
---
...
![打開自訂 Prebuilt 的頁面](/deploy/customize-prebuilt/open-customize-page.webp)
...
![Edit TOML 的打開方式](/deploy/customize-prebuilt/edit-toml.webp)

每個欄位的說明可以參考 [Prebuilt TOML 的 JSON schema 文件](https://json-schema.app/view/%23?url=https%3A%2F%2Fschema.zeabur.app%2Fprebuilt.json)，TOML 的撰寫說明可以參閱這份 [TOML 格式文件](https://toml.io/en/v1.0.0)。如果有任何撰寫上的疑問，歡迎與 [客服](/community/help) 詢問。
