...
Create a Project in [Zeabur Dashboard](https://zeabur.com/new).

## Step 2: Create Services

Create Prebuilt Services for both NGINX and Vaultwarden in the above Project.

![Create NGINX Service](/data-management/config-edit/nginx.png)

![Create Vaultwarden Service](/data-management/config-edit/vaultwarden.png)
...
![Open Config Editor](/data-management/config-edit/nginx_open_config.png)
...
![Add Config File](/data-management/config-edit/nginx_create_config_file.png)
...
![Save Config](/data-management/config-edit/Open_Config_Editor.png)
...
![Restart Service](/data-management/config-edit/restart_nginx_Instance.png)
