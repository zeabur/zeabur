...
![Two options to bind a domain](/infrastructure/networking/public-networking/two-buttons-to-bind-domain.webp)
...
![Binding a zeabur.app domain](/infrastructure/networking/public-networking/binding-zeabur-app-domain.webp)

Once your `zeabur.app` domain is set up, you can access your service using the domain name provided by Zeabur.

![Bound zeabur.app domain](/infrastructure/networking/public-networking/bound-zeabur-app-domain.webp)
...
![Binding a custom domain](/infrastructure/networking/public-networking/binding-custom-domain.webp)

After adding your domain name, you'll see the DNS information for your domain.

![Setting DNS for your domain](/infrastructure/networking/public-networking/custom-domain-setting-dns.webp)
...
![Configuring DNS in Cloudflare](/infrastructure/networking/public-networking/configure-dns-record-in-cloudflare.webp)
...
![Bound custom domain](/infrastructure/networking/public-networking/bound-custom-domain.webp)
...
2. Then, open [Google Admin Toolbox - Dig](https://toolbox.googleapps.com/apps/dig/#A/) and enter this hostname.
   ...
   ![Google Admin Toolbox - Dig](/infrastructure/networking/public-networking/google-dig-tool.webp)
   <br />
...
![Binding custom domain for redirection](/infrastructure/networking/public-networking/binding-custom-domain-for-redirect.webp)

## Deleting Domains

To delete a domain, click the trash bin icon next to the domain name.

![Delete button](/infrastructure/networking/public-networking/delete-button.webp)

Then, enter your domain name in the input box and click the "Delete" button to confirm.

![Deleting domain modal](/infrastructure/networking/public-networking/deleting-domain-modal.webp)
...
![Assigned hostname and port](/infrastructure/networking/public-networking/assigned-hostname-and-port.webp)
