...
![file management](/infrastructure/datastores/file-management/file-management.png)
...
![create folder](/infrastructure/datastores/file-management/create-folder.png)
...
![create file](/infrastructure/datastores/file-management/create-file.png)
...
![edit file](/infrastructure/datastores/file-management/edit-file.png)
...
![delete file](/infrastructure/datastores/file-management/delete-file.png)
...
![download file](/infrastructure/datastores/file-management/download-file.png)

![select downloaded file destination](/infrastructure/datastores/file-management/download-select-destination.png)
...
![upload file](/infrastructure/datastores/file-management/upload.png)

### Uploading Directories

To upload an entire directory, first compress it into a `tar` file:

![compress directory as TAR file](/infrastructure/datastores/file-management/compress-as-tar.png)

Drag the compressed `tar` file to the `/tmp` directory in the Zeabur file management interface:

![upload TAR file to temporary path](/infrastructure/datastores/file-management/upload-tar-file.png)
...
![extracted folder structure](/infrastructure/datastores/file-management/extracted-folder-structure.png)
