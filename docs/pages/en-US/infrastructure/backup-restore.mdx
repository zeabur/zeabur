...
<Callout>
    If you have not mounted [volumes](/infrastructure/datastores/volumes), the backup feature will not be displayed. "Backup" will only back up the data within the volumes; other files in the service (such as source code) will not be backed up.
</Callout>
...
If you want to restore data within [volumes](/infrastructure/datastores/volumes), you can refer to the [File Management](/infrastructure/datastores/file-management) method to upload the backup files to the target directory and decompress them.
