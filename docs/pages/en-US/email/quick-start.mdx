...
- Check out the [REST API Reference](/en-US/email/rest-api) to learn about more features
- Configure [Webhooks](/en-US/email/webhooks) to receive email status notifications
- Learn how to send [emails with attachments](/en-US/email/rest-api#sending-emails-with-attachments)
- Explore [scheduled sending](/en-US/email/rest-api#scheduling-emails) and [batch sending](/en-US/email/rest-api#batch-sending)
