...
<Callout type="info">
  **Recommended: Use [Zeabur Domain](/domain) to register your domain.** If your domain is registered through Zeabur Domain, you can set up Zeabur Email in one click from the domain detail page — all required DNS records (DKIM, SPF, DMARC) are created automatically, no manual configuration needed.
</Callout>
