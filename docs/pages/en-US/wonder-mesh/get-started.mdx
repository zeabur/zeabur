...
In "Create New Project" page, under "Select a Server", select **Bind External Server**, then choose **Wonder Mesh**. Configure your device's architecture (amd64 or arm64) and operating system (Linux or macOS).
...
To remove Wonder Mesh from your server, see [Uninstall](./uninstall).
