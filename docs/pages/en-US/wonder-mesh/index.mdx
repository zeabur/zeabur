...
After deploying a service, open the **Networking** tab on the service page to find the LAN access address. You can then access the service from any device on the same local network. See the [Get Started guide](./get-started#step-6-start-deploying) for details on finding your device's LAN IP.
