...
- **From your local network**: Open the **Networking** tab on the service page to find the LAN access address. See the [Get Started guide](./get-started#accessing-services-from-your-local-network) for details on finding your device's LAN IP.
