...
### Can I add multiple devices to my account?

Yes. Each device joins your mesh network independently, and you can choose which device to deploy each service to.
