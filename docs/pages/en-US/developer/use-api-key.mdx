...
The access method for the GrapQL API is the same as above, but the request method is different. You can try the GraphQL API in the [GraphQL Playground](https://api.zeabur.com/graphql).
