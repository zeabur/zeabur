...
ogImageTitle: Z-Send API Key Management
ogImageSubtitle: Create and Manage API Access Keys
---

# API Key Management

API keys are used to authenticate your Z-Send API requests. Each key can have different permission levels.

## Permission Types

Z-Send provides three permission levels:
...
View usage statistics for each key in the Z-Send console:
