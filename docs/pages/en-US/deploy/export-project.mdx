...
<Callout>
    Note that "Export Project" **does not include data**. For information on data backup and restoration, please refer to the documentation, [Backup Service](/infrastructure/backup-restore) and [Restore Backup](/infrastructure/backup-restore)
</Callout>
