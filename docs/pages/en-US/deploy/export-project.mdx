...
<Callout>
    Note that "Export Project" **does not include data**. For information on data backup and restoration, please refer to the documentation, [Backup Service](/infrastructure/datastores/backup-restore) and [Restore Backup](/infrastructure/datastores/backup-restore)
</Callout>
