...
When specifying from the GUI, the default entrypoint when setting this field is `/bin/sh`. If your image does not provide `/bin/sh`, use **Edit TOML** to change it or consult [Zeabur Forum](https://zeabur.com/forum) for assistant.
...
If you have any questions about writing your own template, feel free to contact [Zeabur Forum](https://zeabur.com/forum).
