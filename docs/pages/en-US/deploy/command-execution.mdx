...
![Open the Command Execution Interface](/deploy/command-execution/Command_part1.png)
...
![Command Execution Interface](/deploy/command-execution/terminal.png)

## Execute Commands

Taking a basic `echo` as an example, enter `echo Hello, World!` and you should see the output result `Hello, World!`.

![Execute hello world Command](/deploy/command-execution/terminal_2.png)

Entering a non-existent command will display an error code.

![Command Execution Failure](/deploy/command-execution/terminal_3.png)
...
![Execute MySQL Command](/deploy/command-execution/MySQL_terminal.png)
