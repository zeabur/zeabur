...
With our deploy button, it is easy to deploy services to Zeabur with one click. The button works as a plug-in that can be embedded in any markdown file or HTML file. It can transform any [Zeabur template](https://zeabur.com/templates) into a deployable project.
