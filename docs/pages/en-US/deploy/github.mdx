...
If you registered your Zeabur account using an email address, you'll need to first link your GitHub account to your Zeabur account. You can complete this linking in the [Console > Settings > Integrations](https://zeabur.com/account/general).
