...
Besides, you can [set the budget and manage the usages](../operations/project-budget) for project, [invite other team members](../operations/invite-member) to manage the services and so on.
...
and then select a server option:

- Choose an existing **Dedicated Server**
- Select **Buy New Server**
- Choose **Bind External Server** (connect your own server via SSH)
