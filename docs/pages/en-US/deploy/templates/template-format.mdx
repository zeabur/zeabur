...
ogImageTitle: Template Format
ogImageSubtitle: YAML resource format for Zeabur templates
---
...
- **Test & deploy** your template with the CLI — see [Maintain & Update Templates](/deploy/templates/maintain-template) for CLI usage.
- **Publish** your template to the marketplace for others to use.
