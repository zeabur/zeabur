...
Besides, you can [set the budget and manage the usages](../operations/project-team/project-budget) for project, [invite other team members](../operations/project-team/invite-member) to manage the services and so on.
