...
Go to [your dashboard of Zeabur](https://zeabur.com) and create a new project if you haven't done so.
...
<Callout>
    ...
    You can check a more detailed guide [here](/deploy/methods/github-integration).
</Callout>
