...
Or use [environment variables](/deploy/config/environment-variables) to set it:
...
Or set [environment variables](/deploy/config/environment-variables):
...
You can also use [environment variables](/deploy/config/environment-variables) to set the build and start commands:
