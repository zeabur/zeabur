...
You can adjust this list in the `Caddyfile` as needed. You are welcome to share additional suggestions for unsafe paths with us on [the community forum](https://zeabur.com/forum).
