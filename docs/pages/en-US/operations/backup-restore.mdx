...
<Callout>
    If you have not mounted [volumes](/operations/volumes), the backup feature will not be displayed. "Backup" will only back up the data within the volumes; other files in the service (such as source code) will not be backed up.
</Callout>
...
If you want to restore data within [volumes](/operations/volumes), you can refer to the [File Management](/operations/file-management) method to upload the backup files to the target directory and decompress them.
