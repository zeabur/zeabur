...
- Data in [volumes](/operations/data/volumes) is retained.
...
Zeabur will start a new deployment using the most recent configuration. The service goes through the normal [health check](/operations/monitoring/health-checks) process and begins accepting traffic once ready.
