...
If your workload has grown beyond what a single machine can reliably handle, or you need cross-node scheduling, failover, and distributed storage, what you usually need is not a single [server](/dedicated-server) — it's a **cluster**.
...
3. To learn about the single-machine option, see [Servers](/dedicated-server).
