...
That's it. Your Railway application is now running on Zeabur. The two platforms have a very similar developer experience, so you should feel right at home. If you run into any issues, reach out on our [Discord community](https://zeabur.com/dc).
