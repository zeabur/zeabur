...
That's it. Your Vercel application is now running on Zeabur as a full-stack platform with databases, backend services, and your frontend — all in one place. If you run into any issues, reach out on our [Discord community](https://zeabur.com/dc).
