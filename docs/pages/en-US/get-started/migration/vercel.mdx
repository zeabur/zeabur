...
| Vercel Postgres / KV / Blob | Marketplace → PostgreSQL, Redis, or object storage |
...
- **PostgreSQL, MySQL, MongoDB**: Click **Add Service** → **Marketplace** and select your database.
- **Redis**: Available in the marketplace for caching and session storage.
...
| Databases | Vercel Postgres, KV, Blob (limited) | Full marketplace (PostgreSQL, MySQL, MongoDB, Redis, etc.) |
