...
| Pricing model | Per-VM + bandwidth | [Subscription plan](/pricing) + server costs |

---

That's it. Your Fly.io application is now running on Zeabur. If you run into any issues, contact [Zeabur Support](https://zeabur.com/support).
