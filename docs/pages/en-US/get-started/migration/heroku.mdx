...
| Scaling | Dyno types (Basic, Standard, Performance) | Resource allocation in the dashboard |
...
| Pricing | Per-dyno monthly pricing | [Subscription plan](/pricing) + server costs |
...
That's it. Your Heroku application is now running on Zeabur with no dynos, no Procfiles, and no slug size limits. If you run into any issues, contact [Zeabur Support](https://zeabur.com/support).
