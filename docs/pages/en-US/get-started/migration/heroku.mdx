...
That's it. Your Heroku application is now running on Zeabur with no dynos, no Procfiles, and no slug size limits. If you run into any issues, reach out on our [Discord community](https://zeabur.com/dc).
