...
<Callout type="info">
Combining these practices with Zeabur's built-in features — like [high availability](/deploy/high-availability) and [edge caching](/deploy/edge-caching) — gives you a solid foundation for production workloads.
</Callout>
