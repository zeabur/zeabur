...
Each [server](/dedicated-server) has its own firewall configuration. By default, Zeabur opens the ports required for services to operate (such as 80 and 443) and blocks all other unauthorized inbound connections.
