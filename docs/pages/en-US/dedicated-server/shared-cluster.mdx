...
<Callout type="error">
Shared clusters are being phased out. New projects can no longer be created on shared clusters, and existing shared cluster projects will stop accepting new services from **April 1, 2026**. All new projects should use [Dedicated Servers](/dedicated-server).
</Callout>
