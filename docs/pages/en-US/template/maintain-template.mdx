...
1. Edit your Template Resource YAML file (see [Template Format](/template/template-format) for the format).
...
Zeabur rewards community contributors through the [Contribution Reward Program](/rewards/contribution). Template maintainers can earn the following:
...
- **Referral earnings**: Enable a referral code in your template's [Deploy Button](/deploy/methods/deploy-button). For each new user who signs up through the button and upgrades to a paid plan, you'll earn US$5 in Credits.

<Callout type="info">
To claim rewards, create a post on the [Zeabur community forum](https://zeabur.com/forum) with your template link and account information.
</Callout>
