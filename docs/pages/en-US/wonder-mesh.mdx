...
- **From the internet via port forwarding**: If your network supports it, bind a domain to your service just like any other Zeabur server. See [Public Networking](/networking/public) for details.
