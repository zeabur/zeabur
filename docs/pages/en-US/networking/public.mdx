...
<Callout type="info">
  If your service is deployed on a [Wonder Mesh](/wonder-mesh) server, you can also access it directly from your local network without a domain or port forwarding. See [Accessing Services](/wonder-mesh/get-started#accessing-services) for details.
</Callout>
