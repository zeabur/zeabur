...
<Callout type="info">
  Private networking is for **service-to-service communication** within the same project — not for accessing services from your local machine. If you are using [Wonder Mesh](/wonder-mesh) and want to access services from your local network, see [Accessing Services](/wonder-mesh/get-started#accessing-services).
</Callout>
