...
<Callout type="info">
  This high availability architecture is designed for users of **Dedicated Clusters** (multi-node Kubernetes clusters). It is not applicable to single-node **Dedicated Servers**. Zeabur is also [phasing out shared clusters](https://zeabur.com/changelogs/phasing-out-shared-cluster) — new projects should use Dedicated Servers or Dedicated Clusters.
</Callout>
