...
Yes. The subscription plan (e.g. Developer Plan) and the dedicated server are separate purchases. The plan gives you access to Zeabur's platform features, support, and shared cluster credits. The dedicated server is the infrastructure where your services run. You need an active plan **and** a server to deploy services on a dedicated server.

### What happens if I cancel and re-subscribe to the Developer Plan within the same billing period?

Canceling and re-subscribing will create a new subscription and charge you again. The previous subscription's remaining period is not carried over. If you were charged twice within the same period, contact [Zeabur support](mailto:contact@zeabur.com) to request a refund for the duplicate charge.
