...
- **VKVM**: We are unable to offer refunds for VKVM servers, as they do not support refund operations.
- **Tencent Cloud**: We are unable to offer refunds for Tencent Cloud servers, as they do not support refund operations. If you need to upgrade the specification of your machine, you can [contact us](https://zeabur.com/dc) to pay the difference and upgrade in place.
