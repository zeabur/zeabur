...
Yes. For Chinese users, you can also use Alipay for subscriptions.
...
If you need customized billing information on your invoices (e.g., company name, tax ID, or address), you must subscribe to the **Developer Plan** or above. If you require a formal invoice (發票), you must subscribe to the **Team Plan**.
