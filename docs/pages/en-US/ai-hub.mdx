...
AI Hub is a unified AI service platform that allows you to access multiple AI models (such as OpenAI, Claude, etc.) through a single interface, with transparent pay-as-you-go pricing based on actual usage.
...
1. Log in to [Zeabur Dashboard](https://zeabur.com/projects)
...
| Model Family | Provider | Representative Models | Official Docs |
| --- | --- | --- | --- |
| **GPT** | [OpenAI](https://openai.com) | GPT-4o, GPT-4o mini, o1, o3-mini | [Model docs](https://platform.openai.com/docs/models) |
| **Claude** | [Anthropic](https://www.anthropic.com) | Claude 3.5 Sonnet, Claude 3 Opus | [Model docs](https://docs.anthropic.com/en/docs/about-claude/models) |
| **Grok** | [xAI](https://x.ai) | Grok-2 | [Model docs](https://docs.x.ai/docs) |

<Callout>
  The model list is continuously updated. Visit [Zeabur Models](https://zeabur.com/en-US/models) for the full list of supported models and real-time pricing.
</Callout>
...
- [Using Zeabur AI Hub in n8n](./ai-hub/n8n-integration): Workflow automation
- [Using Zeabur AI Hub in SillyTavern](./ai-hub/sillytavern-integration): Role-playing conversations
...
- [n8n Integration Guide](./ai-hub/n8n-integration)
- [SillyTavern Integration Guide](./ai-hub/sillytavern-integration)
