...
Refer to the following contribution methods, then let us know your contribution in the community forum. We will grant you the corresponding free usage credits based on your contribution.
...
Creating templates helps other developers deploy more open-source projects to Zeabur with one click. Refer to [Creating Templates from YAML](../template/template-format) to learn how to create templates.
...
If you want to participate in the contribution reward program, please first join [Zeabur community forum](https://zeabur.com/forum) and let us know that you are interested in participating in the contribution reward program. Tell us which template or documentation page you plan to submit, supplement, or translate.
