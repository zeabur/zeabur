...
| スケーリング | Dyno タイプ（Basic、Standard、Performance） | ダッシュボードでリソースを割り当て |
...
| 料金 | Dyno 単位の月額課金 | [サブスクリプションプラン](/pricing) + サーバー料金 |
...
以上です。Heroku アプリケーションが Zeabur で稼働しています。dyno なし、Procfile なし、slug サイズ制限なし。問題が発生した場合は、[Zeabur サポート](https://zeabur.com/support)にお問い合わせください。
