...
次に、[Zeaburコンソール](https://zeabur.com)に移動し、新しいプロジェクトを作成します。
...
<Callout>
    ...
    詳細な手順については、[こちら](/deploy/methods/github-integration)を参照してください。
</Callout>
...
ドメインをサービスにバインドする方法の詳細については、[ドメインのバインド](/deploy/networking/public-networking)を参照してください。
