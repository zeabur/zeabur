...
または、[環境変数](/deploy/config/environment-variables) を使用して設定します：
...
または、[環境変数](/deploy/config/environment-variables) を設定します：
...
[環境変数](/deploy/config/environment-variables) を使用して、ビルドと起動コマンドを設定することもできます：
