...
首先，你需要在本機開發環境初始化一個 Spring Boot 專案，我們可以按照 [Spring Boot 官方文件](https://spring.io/quickstart) 的指示來完成這個步驟，或是依據你喜好的 IDE（例如 [IntelliJ IDEA](https://www.jetbrains.com/idea/) 或 [Eclipse](https://www.eclipse.org/) 等等），初始化 Spring Boot 專案。
