...
We've prepared a [template](https://github.com/zeabur/elysia-template) for ElysiaJS App, you can use the template with click on the **Use this template** button.
