...
Same as [Personal Repository](/docs/en-US/intergration/github#personal-repositories), additionally, you need to select the organization you want to operate on in `Github`'s `Settings` - `Switch to another account`.