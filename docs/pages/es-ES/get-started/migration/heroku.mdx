...
| Escalado | Tipos de Dyno (Basic, Standard, Performance) | Asignación de recursos en el dashboard |
...
| Precios | Precio mensual por dyno | [Plan de suscripción](/pricing) + costos del servidor |
...
Listo. Tu aplicación de Heroku ahora está ejecutándose en Zeabur sin dynos, sin Procfiles y sin límites de tamaño slug. Si encuentras algún problema, contacta con [Soporte de Zeabur](https://zeabur.com/support).
