...
Los secretos subidos a Git quedan permanentemente expuestos en el historial de tu repositorio. Usa siempre la gestión de variables de entorno de Zeabur.
</Callout>
