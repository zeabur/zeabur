...
Cada [servidor dedicado](/dedicated-server) tiene su propia configuración de firewall. Por defecto, Zeabur abre los puertos necesarios para que los servicios funcionen (como el 80 y el 443) y bloquea todas las demás conexiones entrantes no autorizadas.
...
1. Vaya a la [página de Servidores de Zeabur](https://zeabur.com/servers) y seleccione su servidor dedicado.
