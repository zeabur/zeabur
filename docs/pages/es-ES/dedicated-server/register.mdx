...
Este artículo explicará cómo registrar un [Servidor](../dedicated-server) en Zeabur. Si no tienes tu propio servidor, puedes [comprar uno en Zeabur](./purchase) en su lugar.
