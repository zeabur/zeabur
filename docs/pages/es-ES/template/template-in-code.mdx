...
## Eliminar plantillas usando la CLI `zeabur`

Si tienes plantillas duplicadas o ya no necesitas una plantilla, puedes eliminarla usando el comando `npx zeabur@latest template delete`:
...
Simplemente ejecuta el comando e ingresa el código de la plantilla cuando se te solicite. La plantilla será eliminada permanentemente de la plataforma.
