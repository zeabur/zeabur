...
<Callout type="info">
  Esta arquitectura de alta disponibilidad se aplica tanto a **Servidores Dedicados** como a **Clústeres Dedicados**. Sin embargo, el escalado horizontal (réplicas de servicios) requiere un **Clúster Dedicado** (clúster Kubernetes de múltiples nodos). Zeabur también está [eliminando gradualmente los clústeres compartidos](https://zeabur.com/changelogs/phasing-out-shared-cluster) — los nuevos proyectos deben usar Servidores Dedicados o Clústeres Dedicados.
</Callout>
