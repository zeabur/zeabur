...
<Callout type="info">
  Esta arquitectura de alta disponibilidad está diseñada para usuarios de **Clústeres Dedicados** (clústeres Kubernetes de múltiples nodos). No es aplicable a **Servidores Dedicados** de un solo nodo. Zeabur también está [eliminando gradualmente los clústeres compartidos](https://zeabur.com/changelogs/phasing-out-shared-cluster) — los nuevos proyectos deben usar Servidores Dedicados o Clústeres Dedicados.
</Callout>
