...
1. Despliega MongoDB en Zeabur usando la plantilla de MongoDB:
   **👉 [Plantilla de MongoDB](https://zeabur.com/templates/KXL04P)**
2. En la página del servicio de MongoDB, abre la pestaña **Instruction** / **Connections** y copia el string de conexión (URI).
