...
2. **Instala dependencias:**
    ...
    Los proyectos Bolt generalmente detectan el gestor de paquetes automáticamente. Busca un archivo de bloqueo (`pnpm-lock.yaml`, `package-lock.json`, o `yarn.lock`).
...
3. **Configuración del entorno:**
    ...
    - **Importante:** Si tu aplicación Bolt usaba claves de API (OpenAI, Supabase, etc.), debes agregar manualmente estas claves a tu archivo local `.env`. Bolt no exporta tus secretos a GitHub por razones de seguridad.
4. **Prueba local:**

    Ejecuta el servidor de desarrollo para asegurarte de que la aplicación funciona fuera del sandbox de Bolt.
...
![Agente Zeabur maneja el resto.png](https://cdn.zeabur.com/replit%20migration%20/Zeabur%20Agent%20Handle%20the%20rest.png)
...
4. Visita la URL. Tu aplicación Bolt.new es ahora una aplicación de producción completamente implementada.
...
**👉 [Haz clic aquí para leer nuestra guía sobre cómo conectar Supabase con Zeabur]()**
