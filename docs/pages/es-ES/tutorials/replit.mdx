...
## Paso 2: Abre en un editor local e instala la extensión de Zeabur

Descomprime el archivo y abre la carpeta del proyecto en un editor de código local como VS Code o Cursor. Para hacer el despliegue increíblemente simple, utilizarás la extensión de Zeabur.
...
## Paso 3: Descomprime y abre el proyecto
...
![El agente de Zeabur se encarga del resto](https://cdn.zeabur.com/replit%20migration%20/Zeabur%20Agent%20Handle%20the%20rest.png)
...
**👉 Sigue la próxima guía para crear y conectar PostgreSQL en Zeabur (próximamente).**
