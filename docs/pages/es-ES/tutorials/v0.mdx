...
Publicaremos un tutorial dedicado mostrando cómo crear una base de datos Supabase en Zeabur y conectarla a tu aplicación. Si necesitas una opción alojada ahora, también puedes usar Supabase.
