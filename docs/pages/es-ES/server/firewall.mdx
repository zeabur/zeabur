...
Cada [servidor](/server) tiene su propia configuración de firewall. Por defecto, Zeabur abre los puertos necesarios para que los servicios funcionen (como el 80 y el 443) y bloquea todas las demás conexiones entrantes no autorizadas.
...
- **Usar red privada** — Para la comunicación entre servicios, utilice la [red privada](/deploy/networking/private-networking) para evitar transmitir datos sensibles por Internet público.
