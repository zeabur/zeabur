...
Este artículo te explicará cómo mantener tu [servidor](../server) registrado con Zeabur.
...
![Información del servidor mostrando el estado de K3s](/server/server-info.png)

Para recuperar, ve a **Settings** y haz clic en **Reboot Server**.

![Botón Reboot Server en Settings](/server/reboot-server-button.png)
...
![Diálogo de Reboot Server con lista de servicios](/server/reboot-dialog.png)

Haz clic en **Deselect All** para evitar que cualquier servicio se inicie automáticamente, luego haz clic en **Reboot**.

![Diálogo de Reboot Server con todos los servicios deseleccionados](/server/reboot-deselected.png)
...
![Configuración de Reserva de Recursos](/server/resource-reservation.png)
...
![Conectarse por SSH desde el panel de Zeabur](/server/server-ssh-from-dashboard.webp)
...
![Eliminar Servidor](/server/remove-server.webp)
