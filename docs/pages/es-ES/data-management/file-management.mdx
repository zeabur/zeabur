...
El contenido del archivo editado también se colocará en el [Editor de Configuración](/data-management/config-edit), asegurando que los cambios se mantengan después de reiniciar el servicio. Para revertir un archivo a su estado original, elimina el elemento correspondiente en el Editor de Configuración.
