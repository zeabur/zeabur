...
<Callout type="info">
  Si tu servicio está desplegado en un servidor de [Wonder Mesh](/wonder-mesh), también puedes acceder a él directamente desde tu red local sin un dominio ni redirección de puertos. Consulta [Acceder a los servicios desde tu LAN](/wonder-mesh/get-started#accessing-services) para más detalles.
</Callout>
...
Puedes configurar los puertos durante [la configuración del servicio Docker](/deploy/methods/custom-docker-image). Consulta la sección "Puertos" en la documentación de configuración de Docker para más detalles.
