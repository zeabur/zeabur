...
Si tu Dockerfile no está en la raíz del repositorio, o su nombre no sigue la convención `*.Dockerfile` / `Dockerfile.*`, usa esta variable para especificar la **ruta relativa completa desde la raíz del repositorio**:
