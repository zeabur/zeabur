...
Puedes convertir tu archivo Docker Compose en un archivo YAML de plantilla de Zeabur. Para más detalles, consulta [Creando plantillas desde YAML](/template/template-format). Si necesitas ayuda, no dudes en contactarnos en [comunidad](/community/help).
