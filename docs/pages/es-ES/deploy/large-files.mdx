...
Si tu aplicación genera o requiere archivos grandes en tiempo de ejecución — como archivos subidos por usuarios, archivos de caché o bases de datos — usa [Volúmenes Persistentes](/data-management/volumes) en lugar de incluirlos en la imagen del contenedor.
...
- **Divide repositorios grandes** — si tu repositorio contiene muchos servicios independientes, considera dividirlos en repositorios separados y usar [Rutas de Vigilancia](/deploy/config/watch-paths) o [Directorio Raíz](/deploy/config/root-directory) para gestionar los despliegues.
