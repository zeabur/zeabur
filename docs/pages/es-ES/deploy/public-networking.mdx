...
<Callout type="info">
  Si tu servicio está desplegado en un servidor [Wonder Mesh](/wonder-mesh), también puedes acceder a él directamente desde tu red local sin necesidad de un dominio ni reenvío de puertos. Consulta [Acceder a servicios desde tu red LAN](/wonder-mesh/get-started#accessing-services) para más detalles.
</Callout>
