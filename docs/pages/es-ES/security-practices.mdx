...
Los datos de los clientes almacenados en Zeabur — incluyendo bases de datos, volúmenes de aplicaciones y copias de seguridad — se cifran en reposo utilizando las capacidades de cifrado nativas de cada proveedor de infraestructura (por ejemplo, cifrado de AWS EBS, cifrado de discos persistentes de GCP). Las claves de cifrado son gestionadas por los respectivos proveedores de nube.
...
- Para más detalles, consulta nuestra [Política de privacidad](/docs/en-US/privacy-policy).
