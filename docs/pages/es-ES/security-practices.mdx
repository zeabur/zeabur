...
Si descubres una vulnerabilidad de seguridad en Zeabur, por favor infórmala a [contact@zeabur.com](mailto:contact@zeabur.com). Nos tomamos todos los informes en serio y los investigaremos y responderemos con prontitud. Te pedimos que nos concedas un tiempo razonable para resolver el problema antes de su divulgación pública.
