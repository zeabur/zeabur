...
2. El nuevo despliegue pasa por el proceso estándar de [verificación de salud](/operations/monitoring/health-checks).
...
<Callout type="warning">
  Si tu despliegue involucró migraciones de base de datos u otros cambios con estado, planifica tu reversión cuidadosamente. Considera restaurar una [copia de seguridad de la base de datos](/operations/data/backup-restore) junto con la reversión de la aplicación si es necesario.
</Callout>
...
- **Monitorea después de desplegar.** Observa las [métricas](/operations/monitoring/metrics) y los [registros](/operations/monitoring/logging) después de cada despliegue para detectar problemas tempranamente.
