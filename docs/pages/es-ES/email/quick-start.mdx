...
- Consultar la [Referencia de API REST](/es-ES/email/rest-api) para conocer más funciones
- Configurar [Webhooks](/es-ES/email/webhooks) para recibir notificaciones de estado de correo
- Aprender cómo enviar [correos con archivos adjuntos](/es-ES/email/rest-api#enviar-correos-con-archivos-adjuntos)
- Explorar [envío programado](/es-ES/email/rest-api#programar-correos) y [envío por lotes](/es-ES/email/rest-api#envío-por-lotes)
