...
First, ensure that you have installed the Zeabur CLI according to the guide [Deploy in CLI](/developer/cli).
...
Navigate to the [Zeabur Dashboard](https://zeabur.com) and create a new project.
...
<Callout>
    ...
    GitHub App.
    You can view a more detailed guide [here](/deploy/methods/github-integration).
</Callout>
...
For more information on how to bind a domain to your service, please refer to [Bind a domain](/deploy/networking/public-networking).
