...
For more instructions on deploying with the Zeabur CLI, please see [Deploying Services with CLI](/developer/cli).
...
For more information on how to bind a domain to your service, please refer to [Binding Domains](/deploy/networking/public-networking).
