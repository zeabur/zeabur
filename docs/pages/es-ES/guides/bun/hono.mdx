...
For more instructions on deploying using the Zeabur CLI, please see [Deploying Services Using CLI](/developer/cli).
...
For more information on how to bind a domain to your service, please refer to [Domain Binding](/deploy/networking/public-networking).
