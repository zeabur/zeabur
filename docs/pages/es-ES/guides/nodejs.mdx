...
O utilizar [variables de entorno](/deploy/config/environment-variables) para configurarlo:
...
O establecer [variables de entorno](/deploy/config/environment-variables):
...
También puedes usar [variables de entorno](/deploy/config/environment-variables) para establecer los comandos de construcción y arranque:
