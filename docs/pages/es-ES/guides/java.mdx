...
Si todo tu proyecto Java (incluyendo `pom.xml` o `build.gradle`) está en un subdirectorio del repositorio Git, usa la configuración de [Directorio raíz](/deploy/config/root-directory) en su lugar. Esto le indica a Zeabur que trate ese subdirectorio como la raíz del proyecto, y el descubrimiento predeterminado de JAR funcionará normalmente.
