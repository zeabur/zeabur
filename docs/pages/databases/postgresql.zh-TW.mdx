...
首先，你需要先點選 **Add New Server**，並填入相關資訊：
...
[psql](https://www.postgresql.org/docs/current/app-psql.html) 是一個基於終端的 PostgreSQL 工具。它使你能夠以互動方式輸入查詢，將它們傳送至 PostgreSQL，並查看查詢結果。此外，[psql](https://www.postgresql.org/docs/current/app-psql.html) 提供了許多各種類似 shell 的功能，以方便編寫腳本和自動執行各種任務。
