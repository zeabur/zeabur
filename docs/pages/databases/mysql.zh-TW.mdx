...
[mysqlsh](https://dev.mysql.com/doc/mysql-shell/8.0/en/) 是一種高級命令行工具，可用於管理和操作 MySQL 資料庫。它支援多種編程語言，包括 JavaScript、Python 和 SQL 等，讓使用者可以使用自己擅長的語言編寫腳本。
