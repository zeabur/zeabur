...
In your project, click **Deploy New Service** and select **Deploy Other Service** and then **Deploy MongoDB Service**.

![Select "Marketplace"](/framework/deploy.png)

![Select "MongoDB"](/databases/deploy-mongodb.png)

Once you click "Deploy", Zeabur will automatically deploy the MongoDB service for you.
