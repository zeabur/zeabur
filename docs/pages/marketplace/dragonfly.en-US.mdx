...
First, we need to create a project. Go to the [Projects](https://dash.zeabur.com/projects) page, and you'll see a list of projects.

Click the "Create Project" button at the bottom of the list to create a new project.
