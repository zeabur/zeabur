...
- **Marketplace Services** allows you to deploy a service from a marketplace of common services (such as a database or an open source tool), you can see the open source marketplace [here](https://github.com/zeabur/zeabur/tree/main/prebuilts).
