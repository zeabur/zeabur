...
一个 **Template** 可以分成「模板信息」和「服务规格」这两大块。完整格式可以在 [Zeabur 的 Schema 存储库](https://json-schema.app/view/%23?url=https%3A%2F%2Fschema.zeabur.app%2Ftemplate.json) 浏览，下面会简述每个字段的用途和其在 Zeabur 模板页面的呈现。
