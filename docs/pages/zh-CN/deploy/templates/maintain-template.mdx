...
1. 修改你的 Template Resource YAML 文件（格式参考[从 YAML 创建模板](/deploy/templates/template-format)）。
...
Zeabur 通过[贡献奖励计划](/rewards/contribution)回馈社区贡献者。模板维护者可以获得以下奖励：
...
<Callout type="info">
奖励申请方式：前往 [Zeabur 社群论坛](https://zeabur.com/forum) 发布帖子，提供模板链接与你的账号信息。
</Callout>
