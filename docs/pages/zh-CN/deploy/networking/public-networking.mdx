...
<Callout type="info">
  如果你的服务部署在 [Wonder Mesh](/wonder-mesh) 服务器上，你也可以直接从局域网访问，无需域名或端口转发。详情请参阅[从局域网访问服务](/wonder-mesh/get-started#accessing-services)。
</Callout>
...
你可以在 [Docker 服务设置](/deploy/methods/custom-docker-image) 时配置端口。详细信息请参阅 Docker 服务设置文档中的「Ports」部分。
