...
## 第 2 步: 在本地编辑器中打开并安装 Zeabur 扩展

解压文件并在 VS Code 或 Cursor 等本地代码编辑器中打开项目文件夹。为了使部署变得非常简单，您将使用 Zeabur 扩展。
...
![Zeabur 代理处理其余部分](https://cdn.zeabur.com/replit%20migration%20/Zeabur%20Agent%20Handle%20the%20rest.png)
