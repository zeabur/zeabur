...
| 扩展 | Dyno 类型（Basic、Standard、Performance） | 在控制面板中分配资源 |
...
| 定价 | 按 dyno 月付 | [订阅方案](/pricing) + 服务器费用 |
...
完成了。你的 Heroku 应用现在已在 Zeabur 上运行，无需 dyno、Procfile 和 slug 大小限制。如遇到任何问题，请联系 [Zeabur 支持](https://zeabur.com/support)。
