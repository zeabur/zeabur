...
或者是使用 [环境变量](/deploy/config/environment-variables) 进行设置：
...
或者是设置 [环境变量](/deploy/config/environment-variables)：
...
你也可以使用 [环境变量](/deploy/config/environment-variables) 来设置编译和启动命令：
