...
请注意，这个主题较为高级。对于您的新创服务，通常不需要高可用性（HA）。最简单的解决方案是将您的服务放在一个项目中，并使用[内网](/networking/private)进行通信；使用[公网](/networking/public)将您的服务暴露到互联网。我们可以为您处理垂直扩展，而在共享集群中，如果一个节点故障，我们可以自动将您的服务迁移到另一个节点。（注意：Zeabur 正在[逐步淘汰共享集群](https://zeabur.com/changelogs/phasing-out-shared-cluster)，新项目请使用专用服务器。）
