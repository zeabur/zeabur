...
1. 修改你的 Template Resource YAML 文件（格式参考[从 YAML 创建模板](/template/template-format)）。
...
- **推荐回馈**：在模板的[一键部署按钮](/deploy/methods/deploy-button)中启用推荐码，每位通过按钮注册并升级付费方案的新用户，你将获得 US$5 的 Credits。

<Callout type="info">
奖励申请方式：通过 [Zeabur 支持](https://zeabur.com/support) 提交请求，提供模板链接与你的账号信息。
</Callout>
