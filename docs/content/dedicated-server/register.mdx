...
This article will explain how to register a [Dedicated Server](../dedicated-server) on Zeabur. If you don't have your own server, you can [purchase one from Zeabur](./purchase) instead.
