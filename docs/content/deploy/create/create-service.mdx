...
After [creating a project](./create-project), you can start deploying services. Click the **Deploy New Service** button (or press `CMD + K` / `Ctrl + K` and select **Deploy New Service**), and you'll see a menu with various deployment options:

![Add Service](/start/project-page-with-add-service.webp)
...
For more details, see [Deploy from Template](/template/deploy-template).
...
For more details, see [Integrating with GitHub](./github).
...
![Simple Function](/deploy/create-service/simple-function.png)
...
![Local Project](/deploy/create-service/local-project.png)
...
For more details, see [Deploy with Docker Image](./customize-prebuilt).
